...
export const SEO_CONSTANTS = {
  SITE_NAME: 'ResCrub',
  SITE_TAGLINE: 'Защита персональных данных частных лиц по 152ФЗ',
...
export const ROUTE_META: RouteMetaMap = {
  // ===== Public Pages =====
  '/': {
    title: 'ResCrub — Защита персональных данных | Удаление данных по 152ФЗ',
    description: 'Защита персональных данных и удаление личной информации согласно 152ФЗ. Управление персональными данными для частных лиц в России.',
    keywords: [
      '152ФЗ',
      'защита персональных данных',
      'удаление персональных данных',
