  ...
  const experts = [
    {
      ...
      avatar: "ЭМ",
      quote: "Защита персональных данных становится критически важной в эпоху цифровизации. ResCrub использует правильный подход - автоматизация процесса удаления данных с соблюдением всех требований российского законодательства.",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center mb-16">
          ...
          <p className="mt-6 text-lg leading-8 text-muted-foreground" data-testid="subtitle-trust">
            Ведущие российские специалисты по кибербезопасности и защите данных о важности ResCrub
          </p>
        </div>
