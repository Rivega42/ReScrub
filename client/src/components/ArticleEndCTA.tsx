...
export default function ArticleEndCTA({ 
  ...
  // Testimonial
  const testimonial = {
    text: "ResCrub помог мне полностью очистить мою цифровую историю. За месяц удалили более 200 записей с моими данными. Теперь я спокоен за свою приватность.",
    author: "Алексей М.",
