  ...
  const testimonials = [
    {
      ...
      content: 'За первый месяц ResCrub удалил мои данные из 47 баз данных российских брокеров. Количество рекламных звонков сократилось с 15-20 в день до 1-2 в неделю. Особенно порадовало, что сервис учитывает требования 152-ФЗ и работает с местными компаниями.',
    ...
    },
    {
      ...
      content: 'Меня поразила скорость и эффективность работы. После утечки данных в одном из банков я получал до 40 звонков в день от всех подряд - от МФО до криптобирж. ResCrub за месяц привёл ситуацию в норму. Теперь рекомендую сервис всем партнёрам.',
    ...
    },
    {
      ...
      content: 'Как мать двоих детей, я была обеспокоена тем, что данные всей семьи могут попасть в руки мошенников. ResCrub не только очистил наши данные из 38 источников, но и настроил мониторинг. Теперь я спокойна за безопасность своих близких.',
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-muted-foreground" data-testid="subtitle-testimonials">
            Узнайте, как ResCrub помог тысячам россиян защитить персональные данные и вернуть спокойствие
          </p>
        </div>
